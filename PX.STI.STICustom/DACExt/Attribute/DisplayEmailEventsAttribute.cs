...
namespace PX.STI.STICustom.DACExt.Attribute
{
    ...
    public class DisplayEmailEventsAttribute : PXEventSubscriberAttribute, IPXFieldDefaultingSubscriber, IPXFieldSelectingSubscriber, IPXFieldUpdatedSubscriber
    {
        ...
        public void FieldDefaulting(PXCache cache, PXFieldDefaultingEventArgs eventHandler)
        {
            ...
            eventHandler.NewValue = ContactService?.FindBuyerEmailForOrder(cache, row);
        }
        ...
        public void FieldSelecting(PXCache cache, PXFieldSelectingEventArgs eventHandler)
        {
            ...
            eventHandler.ReturnValue = ContactService?.FindBuyerEmailForOrder(cache, row);
        }
        ...
        public void FieldUpdated(PXCache cache, PXFieldUpdatedEventArgs eventHandler)
        {
            ...
            if (extendedRow.UsrCSROverride is true)
                cache.SetValueExt<SOOrderExt.usrCSREmail>(row, extendedRow.UsrCSRDisplayEmail);
        }
    }
}
